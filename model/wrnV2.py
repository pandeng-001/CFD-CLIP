...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropRate=0.0):
        ...
        scale_factor = 512 / (32 * widen_factor)
        nChannels = [
            int(16 * scale_factor),
            int(16 * widen_factor * scale_factor),
            int(32 * widen_factor * scale_factor),
            int(64 * widen_factor * scale_factor),
        ]
